...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyatı: " + strawberryPrice + " - Gramaj "
            ...
            //Console.Write("Yolcu TV Kimlik No: ");
            //passengerIdentityNumber = Console.ReadLine();

            //Console.WriteLine ("Yolcu TC Kimlik No:  " + passengerIdentityNumber + " " + "Yolcu: " + passengerName + " " + passengerSurname + " " + passengerDistrict + " /" + passengerCity);
